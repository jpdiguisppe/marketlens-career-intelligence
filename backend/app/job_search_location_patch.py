...
METRO_LOCATION_ALIASES: dict[str, set[str]] = {
    "philadelphia": {
        "philadelphia", "philly", "king of prussia", "conshohocken", "malvern",
        "wayne", "radnor", "exton", "west chester", "newtown square",
        "fort washington", "horsham", "blue bell", "plymouth meeting", "audubon",
        "camden", "cherry hill", "mount laurel", "wilmington",
    },
    "philly": {
        "philadelphia", "philly", "king of prussia", "conshohocken", "malvern",
        "wayne", "radnor", "exton", "west chester", "newtown square",
    ...
    "new york": {
        ...
        "bronx", "staten island", "jersey city", "hoboken", "newark",
        "white plains", "long island city",
    },
    "new york city": {
        "new york", "new york city", "nyc", "manhattan", "brooklyn", "queens",
        "bronx", "staten island", "jersey city", "hoboken", "newark",
    ...
    "washington dc": {
        "washington dc", "washington, dc", "district of columbia", "dc",
        "arlington", "alexandria", "bethesda", "silver spring", "mclean",
        "tysons", "reston",
    },
    "washington, dc": {
        "washington dc", "washington, dc", "district of columbia", "dc",
    ...
    "san francisco": {
        "san francisco", "sf", "oakland", "berkeley", "daly city", "san mateo",
        "redwood city", "palo alto", "mountain view", "sunnyvale", "santa clara",
        "san jose",
    },
    "sf": {
        "san francisco", "sf", "oakland", "berkeley", "daly city", "san mateo",
    ...
    "boston": {"boston", "cambridge", "somerville", "brookline", "quincy", "waltham", "newton"},
    "chicago": {"chicago", "evanston", "oak brook", "schaumburg", "naperville", "rosemont"},
    "seattle": {"seattle", "bellevue", "redmond", "kirkland", "renton"},
    "los angeles": {
        "los angeles", "santa monica", "culver city", "burbank", "glendale",
        "pasadena", "long beach", "universal city",
    },
}
...
def apply_job_search_location_patch(job_search: Any) -> None:
    ...
    # Remove ambiguous state abbreviations from city-name aliases. A search for
    # New York City must not match every posting in New York State merely because
    # its location ends in "NY". State-code requests such as "NY" still retain
    # their own broader alias entry.
    for city_key in ("new york", "new york city", "nyc"):
        job_search.LOCATION_ALIASES.setdefault(city_key, set()).discard("ny")
    ...
    def _search_suggestions(
        ...
        suggestions = original_search_suggestions(query, location, level, role_family)
        stale_text = (
